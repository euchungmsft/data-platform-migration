...
resource clusterName_resource 'Microsoft.HDInsight/clusters@2018-06-01-preview' = {
  ...
  properties: {
    ...
    storageProfile: {
      /**
      //  clusterVersion: '3.6' works with error
      storageaccounts: [
        {
          name: '${clusterStorageAccountName}.blob.core.windows.net'
          isDefault: true
          container: 'blob1'
          key: '29omNU+zZSdDNOcEyV9dRG9vA9QTCTYFaklxGGnrkZmDn5BrMhQCbyEWxVjTtKHcW4tw/LdnEDvVKRSqRpGOMg=='
          resourceId: '/subscriptions/b6d4cd53-eeab-41d1-93a8-665daf75fce1/resourceGroups/210429HDMIGPRJ_KRC/providers/Microsoft.Storage/storageAccounts/sakrc002hdmp001/blobServices/default'
        }
      ]
      */
      ...
      storageaccounts: [
        {
          ...
          resourceId: clusterStorageAccountName_default_shareName.id
        ...
        /**
        {
          ...
          container: 'blob1'
          key: listKeys(clusterStorageAccountName_resource.id, '2019-06-01').keys[0].value
          resourceId: clusterStorageAccountName_default_containerName.id
          //msiResourceId: '/subscriptions/b6d4cd53-eeab-41d1-93a8-665daf75fce1/resourcegroups/210429HDMIGPRJ_KRC/providers/Microsoft.ManagedIdentity/userAssignedIdentities/managedid-001'          
        }
        */
      ]
      ...
      storageaccounts: [
        {
          ...
          fileSystem: 'file01'
          key: '29omNU+zZSdDNOcEyV9dRG9vA9QTCTYFaklxGGnrkZmDn5BrMhQCbyEWxVjTtKHcW4tw/LdnEDvVKRSqRpGOMg=='
          //resourceId: '/subscriptions/b6d4cd53-eeab-41d1-93a8-665daf75fce1/resourceGroups/210429HDMIGPRJ_KRC/providers/Microsoft.Storage/storageAccounts/sakrc002hdmp001'
          //resourceId: '/subscriptions/b6d4cd53-eeab-41d1-93a8-665daf75fce1/resourceGroups/210429HDMIGPRJ_KRC/providers/Microsoft.Storage/storageAccounts/sakrc002hdmp001/blobServices/default'
          resourceId: '/subscriptions/b6d4cd53-eeab-41d1-93a8-665daf75fce1/resourceGroups/210429HDMIGPRJ_KRC/providers/Microsoft.Storage/storageAccounts/sakrc002hdmp001/fileServices/default'
          //resourceId: '/subscriptions/b6d4cd53-eeab-41d1-93a8-665daf75fce1/resourceGroups/210429HDMIGPRJ_KRC/providers/Microsoft.Storage/storageAccounts/sakrc002hdmp001/blobServices/default'
          msiResourceId: '/subscriptions/b6d4cd53-eeab-41d1-93a8-665daf75fce1/resourcegroups/210429HDMIGPRJ_KRC/providers/Microsoft.ManagedIdentity/userAssignedIdentities/managedid-001'
        }
      ]
